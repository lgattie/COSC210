...
public class Survey {
    ...
    public Survey(int size) {
        this.numQuestions = 0;
        questions = new Question[size];     //basic array syntax
     ...
     * and puts all the answers into a new SurveyResponse object.
     *
    ...
    public SurveyResponse conduct() {
        ...
        //1.5 - Go ahead and create the scanner object our answer wil use to get all of the answers 
        ...
        for (int i = 0; i < numQuestions; i++) {
            ...
            question.display(); //tell the question to display the primary prompt
