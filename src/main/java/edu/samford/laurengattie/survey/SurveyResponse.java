...
public class SurveyResponse {
    ...
    /**
     * Writes the survey response answers out to a file in this format: 7| I
     * know this topic pretty well. 1| I have no idea what that is. 10| I have
     * written a bunch of program that do File I/O
     *
     * @param filename
