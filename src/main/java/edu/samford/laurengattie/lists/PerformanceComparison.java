...
// 1. Generate a lot of data
        //We need a lot of data, generate the data, 
        //put it in a separate data in a different method
        generateData();
...
// 3. Start Measuring ... Construction first
        //Where can we put all of this data so we don't bias things - FILE
        //intial construction
        ...
        //find the results in a way thats easy to copy & paste into excel
        ...
        // inserting an item at the begining of a data structure
        ...
        finish = System.nanoTime();
        arraytime = finish - start;
        System.out.println("insert begining," + arraytime / 1_000_000 + "," + listtime / 1_000_000);
        ...
        // 1st parameter is the node you want to put something after, 2nd is the new node
